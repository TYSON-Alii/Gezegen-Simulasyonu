...
void sekiller()
{
    ...
    for(float i = -1; i <= 1; i += 0.1){glVertex2f(cos(i*PI)*10,sin(i*PI)*10);}
    glEnd();
    glFlush();
    ...
    for(float i = -1; i <= 1; i += 0.1) {glVertex2f(cos(i*PI)*7,sin(i*PI)*7);}
    glEnd();
    glFlush();
    ...
    for(float i = -1; i <= 1; i += 0.1) {glVertex2f(cos(i*PI)*4,sin(i*PI)*4);}
    glEnd();
    glFlush();
}
